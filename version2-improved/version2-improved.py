...
class LoginWindow:
    ...
    def create_widgets(self):
        ...
        hint_label = tk.Label(
            self.root,
            text="Тестовые данные:\n• Администратор: admin / admin123\n• Преподаватель: teacher1 / teacher1\n• Гость: просмотр без редактирования",
            font=("Arial", 9),
            fg="gray",
            justify="left"
        )
...
class AdminApp:
    ...
    def create_users_tab(self):
        ...
        # Размещение
        self.users_tree.pack(side="top", fill="both", expand=True, padx=10, pady=10)
        scrollbar.pack(side="right", fill="y")
    ...
    def create_stats_tab(self):
        ...
        equip_stats_label.grid(row=0, column=0, sticky="w", pady=(0, 10))
        
        self.equip_stats_text = tk.Text(stats_frame, width=40, height=8, font=("Arial", 10))
        self.equip_stats_text.grid(row=1, column=0, sticky="w", padx=(0, 20))
        ...
        request_stats_label.grid(row=0, column=1, sticky="w", pady=(0, 10))
        
        self.request_stats_text = tk.Text(stats_frame, width=40, height=8, font=("Arial", 10))
        self.request_stats_text.grid(row=1, column=1, sticky="w")
    ...
    def load_stats(self):
        ...
        # Преобразование статусов оборудования
        equip_status_translation = {
            'available': 'Доступно',
        ...
        for status, count in equip_stats:
            translated_status = equip_status_translation.get(status, status)
...
class GuestApp:
    ...
    def create_equipment_tab(self):
        ...
        self.equipment_tree = ttk.Treeview(tab, columns=columns, show="headings", height=20)
        ...
        # Размещение
        self.equipment_tree.pack(side="top", fill="both", expand=True, padx=10, pady=10)
        scrollbar.pack(side="right", fill="y")
